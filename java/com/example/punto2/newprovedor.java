...
public class newprovedor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_newprovedor);
        ...
        DatabaseReference reference1 = database1.getReference("/MI data base Usuarios/" + user.getUid() + "/Provedor");
                ...
                reference1.push().setValue(DatosUsuario).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(newprovedor.this, "Proveedor Registrado correctamente", Toast.LENGTH_SHORT).show();
                         } else {
                            // Ocurrió un error
                         }
                    }
