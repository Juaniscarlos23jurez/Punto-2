...
import com.example.punto2.adaptadores.adaptadorProbedor;
...
public class edProvedor extends AppCompatActivity {
    RecyclerView recyclerView;
    adaptadorProbedor adaptadorProbedor1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ed_provedor);

        auth = FirebaseAuth.getInstance();
        user = auth.getCurrentUser();
        recyclerView = findViewById(R.id.Almacen);
        base = FirebaseDatabase.getInstance().getReference("/MI data base Usuarios/" + user.getUid() + "/Provedor");

        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false));
        provedor1 = new ArrayList<>();
        adaptadorProbedor1 = new adaptadorProbedor(this, provedor1);
